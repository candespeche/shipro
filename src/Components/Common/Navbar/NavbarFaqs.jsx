                ...
                <div className={style.burgerContainer}>
                    <div className={home ? style.linksHome : style.links}>
                        ...
                        <a href="mailto:contacto@shipro.pro">
                            <svg xmlns="http://www.w3.org/2000/svg" className={style.fstSvg} width="31.356" height="24.856" viewBox="0 0>
                                <g id="Icon_feather-mail" data-name="Icon feather-mail" transform="translate(1.393 1)">
                                    <path id="Trazado_30" data-name="Trazado 30" d="M5.857,6H28.713A2.865,2.865,0,0,1,31.57,8.857V26a2.8>
                                    <path id="Trazado_31" data-name="Trazado 31" d="M31.57,9,17.285,19,3,9" transform="translate(-3 -6.1>
                                </g>
                            </svg>
                        </a>
                        ...
                        <a target="_blank" rel="noopener noreferrer" href="https://shipro.pro/login">
                            <svg className={hover3 ? style.hover3onp : style.hover3offp} xmlns="http://www.w3.org/2000/svg" width="26" h>
                                <g id="Icon_feather-user" data-name="Icon feather-user" transform="translate(-5 -3.5)">
                                    <path id="Trazado_97" data-name="Trazado 97" d="M30,31.5v-3a6,6,0,0,0-6-6H12a6,6,0,0,0-6,6v3" fill=">
                                    <path id="Trazado_98" data-name="Trazado 98" d="M24,10.5a6,6,0,1,1-6-6,6,6,0,0,1,6,6Z" fill="none" s>
                                </g>
                            </svg>
